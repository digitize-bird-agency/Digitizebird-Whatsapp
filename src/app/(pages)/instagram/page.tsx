...
import { InstagramFaq, instagramContent, testimonials } from '@/constants/data'
        ...
        <div className='py-10'>
            <section className='container flex flex-col items-start md:items-center md:justify-between md:flex-row'>
                <div className='mt-10 md:mt-0 space-y-4 w-full'>
                    ...
                    <h1 className='text-4xl font-bold tracking-tight'>{instagramContent.heading_one}</h1>
                    <p className='text-lg tracking-tight font-light max-w-lg'>{instagramContent.section_one_paragraph}</p>
            ...
            <Ratings para={instagramContent.rating_para} />
            <div className="container mx-auto p-4 min-h-screen">
                <div className="md:grid md:grid-cols-12 md:gap-4 h-full relative">
                    ...
                    {/* Content Section */}
                    <div className="md:col-span-6">
                        <InfoContainer heading='Work Together' description='Your customers are on Instagram. All the time. So when they&apos;re looking to buy, and they message you, they&apos;re at their moment of highest intent. Engaging with these visitors through a team collaboration inbox.' checkpoints={["Shared inbox for teams", "Assign conversations to agents", "Measure agent performance"]} />
            ...
            <section className='container mx-auto min-h-screen flex flex-col items-start pt-80 pb-40'>
                <h2 className='text-5xl font-semibold tracking-tight'>Instagram is great.<br />
