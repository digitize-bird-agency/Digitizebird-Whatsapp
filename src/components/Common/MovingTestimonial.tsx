                    ...
                    >
                        <blockquote>
                            ...
                            <div className="flex flex-col gap-2 justify-between h-full">
                                <span className=" relative z-20 text-lg tracking-tight leading-[1.6] text-gray-100 font-normal">
                                    {item.quote}
                                </span>
                                <div className="relative z-20 mt-6 flex flex-row gap-2 items-center">
                                    ...
                                    <span className="flex flex-col gap-1">
                                        <span className=" text-lg font-bold text-[#affaff]">
                                            {item.name}
                                        </span>
                                        <span className=" text-sm text-[#95f8ff]  font-normal">
                                            {item.title}
                                        </span>
                                    </span>
                                </div>
